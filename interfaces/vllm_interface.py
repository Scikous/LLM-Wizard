...
# from Sagex.chat_history import Conversation
...
#         image_inputs, video_inputs, video_kwargs = self.vision_processor.process_inputs(messages, self.tokenizer.image_processor.patch_size)
#         mm_data = {}
...
#         self.conversation.add_user_message(prompt, images, videos)
#         if assistant_prompt:
#             self.conversation.add_assistant_message(assistant_prompt)
...
#             instance.vision_processor = get_vision_processor(model_type=config.model_path_or_id)
#         else:
...
#             instance.conversation = config.conversation
#         else:
...
#             messages = self._convo_handler(prompt, images, videos, assistant_prompt)
#         else:
#             messages = prompt
...
#         prompt = self.tokenizer.apply_chat_template(messages, tokenize=False, add_generation_prompt=add_generation_prompt, continue_final_message=continue_final_message)
